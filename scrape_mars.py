...
def scrape():
    ...
    # create mars_data dictionary that we can insert into mongo database
    mars_data = {}
    hemisphere_image_urls = []
    # visit nasa site to get the news
    ...
    news_paragraph = result1.get_text()
    # add title and paragraph to mars data with a key of news_title and news_p
    mars_data["news_title"] = news_title
    mars_data["news_paragraph"] = news_paragraph
    
    # visit jpl site to get space images
    image_url = 'https://www.jpl.nasa.gov/spaceimages/?search=&category=Mars'
    browser.visit(image_url)
    time.sleep(1)
    # get the new html from jpl
    html = browser.html
